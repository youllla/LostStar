		...
		<div class="comment-form" style="width:80%; margin-left:100px; margin-bottom:70px;">
			<h4>Community</h4>
				<div class="form-group">
					<input type="text" class="form-control" id="commTitle" name="commTitle" value="<%=cDTO.getCommTitle() %>" readonly>
				</div>
				<div class="form-group">
					<textarea class="form-control mb-10" rows="10" id="commContent" name="commContent" readonly><%=cDTO.getCommContent() %></textarea>
				</div>
				<a href="/community/commUpdateView.do?commNo=<%=cDTO.getCommNo() %>" class="myButton">수정</a>
				<a href="/community/commDelete.do?commNo=<%=cDTO.getCommNo()%>" class="myButton">삭제</a>
