		...
		<form action="/user/userUpdate.do?userNo=<%=userNo %>" method="post">
			<div style="margin-bottom:100px; padding:0px 10px 0px 10px; text-align:center; margin: 0 auto; width:60%; /* min-width:100% */">
				<div class="mt-10">
					...
					<input type="text" id="name" name="name" placeholder="NAME" required="" class="single-input" style="float:right;" value="<%=uDTO.getName() %>">
				</div>
				<div class="mt-10">
					<b style="color:black; float:left;">TEL</b>
					<input type="text" id="tel" name="tel" placeholder="TEL" required="" class="single-input" value="<%=uDTO.getTel()%>">
				</div>
				<div class="mt-10">
					<b style="color:black; float:left;">ID</b>
					<input type="text" id="id" name="id" placeholder="ID" required="" class="single-input" value="<%=uDTO.getId()%>">
				</div>
